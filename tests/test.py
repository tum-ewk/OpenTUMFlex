...
my_ems['time_data']['end_time'] = '2019-12-19 00:00'
...
my_ems['devices'].update(devices(device_name='ev', minpow=0, maxpow=2, stocap=2, init_soc=[20,35,30],
                                 ...
                                 #          "2019-12-18 13:45", "2019-12-18 18:15"],
                                  ev_aval=["2019-12-18 06:00", "2019-12-18 10:00"],
