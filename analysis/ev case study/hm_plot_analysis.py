...
sb.heatmap(_37_P_pos_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 0], cbar=False, vmin=p_pos_min, vmax=p_pos_max, cmap='Greens')
...
# 11 kW
sb.heatmap(_11_P_pos_const_hm / _37_n_veh_avail_hm, ax=axs[0, 1], cbar=False, vmin=p_pos_min, vmax=p_pos_max, cmap='Greens', edgecolors=None)
...
sb.heatmap(_11_P_pos_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 1], cbar=False, vmin=p_pos_min, vmax=p_pos_max, cmap='Greens')
...
# 22 kW
sb.heatmap(_22_P_pos_const_hm / _37_n_veh_avail_hm, ax=axs[0, 2], cbar=False, vmin=p_pos_min, vmax=p_pos_max, cmap='Greens')
...
sb.heatmap(_22_P_pos_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 2], cbar=False, vmin=p_pos_min, vmax=p_pos_max, cmap='Greens')
...
# 3.7 kW
im = sb.heatmap(_37_P_neg_const_hm / _37_n_veh_avail_hm, ax=axs[0, 3], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
sb.heatmap(_37_P_neg_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 3], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
# 11 kW
sb.heatmap(_11_P_neg_const_hm / _37_n_veh_avail_hm, ax=axs[0, 4], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
sb.heatmap(_11_P_neg_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 4], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
# 22 kW
sb.heatmap(_22_P_neg_const_hm / _37_n_veh_avail_hm, ax=axs[0, 5], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
sb.heatmap(_22_P_neg_const_mi_hm / _37_n_veh_avail_hm, ax=axs[2, 5], cbar=False, vmin=p_neg_min, vmax=p_neg_max, cmap='Blues_r')
...
_37_p_pos_max_const = (_37_P_pos_const_hm / _37_n_veh_avail_hm).max().max()
_11_p_pos_max_const = (_11_P_pos_const_hm / _37_n_veh_avail_hm).max().max()
_22_p_pos_max_const = (_22_P_pos_const_hm / _37_n_veh_avail_hm).max().max()
_37_p_neg_mean_const = (_37_P_neg_const_hm / _37_n_veh_avail_hm).mean().mean()
_11_p_neg_mean_const = (_11_P_neg_const_hm / _37_n_veh_avail_hm).mean().mean()
_22_p_neg_mean_const = (_22_P_neg_const_hm / _37_n_veh_avail_hm).mean().mean()
_37_p_pos_mean_const = (_37_P_pos_const_hm / _37_n_veh_avail_hm).mean().mean()
_11_p_pos_mean_const = (_11_P_pos_const_hm / _37_n_veh_avail_hm).mean().mean()
_22_p_pos_mean_const = (_22_P_pos_const_hm / _37_n_veh_avail_hm).mean().mean()
...
_37_p_neg_max_const_mi = (_37_P_neg_const_mi_hm / _37_n_veh_avail_hm).min().min()
_11_p_neg_max_const_mi = (_11_P_neg_const_mi_hm / _37_n_veh_avail_hm).min().min()
_22_p_neg_max_const_mi = (_22_P_neg_const_mi_hm / _37_n_veh_avail_hm).min().min()
_37_p_pos_max_const_mi = (_37_P_pos_const_mi_hm / _37_n_veh_avail_hm).max().max()
_11_p_pos_max_const_mi = (_11_P_pos_const_mi_hm / _37_n_veh_avail_hm).max().max()
_22_p_pos_max_const_mi = (_22_P_pos_const_mi_hm / _37_n_veh_avail_hm).max().max()
_37_p_neg_mean_const_mi = (_37_P_neg_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
_11_p_neg_mean_const_mi = (_11_P_neg_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
_22_p_neg_mean_const_mi = (_22_P_neg_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
_37_p_pos_mean_const_mi = (_37_P_pos_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
_11_p_pos_mean_const_mi = (_11_P_pos_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
_22_p_pos_mean_const_mi = (_22_P_pos_const_mi_hm / _37_n_veh_avail_hm).mean().mean()
