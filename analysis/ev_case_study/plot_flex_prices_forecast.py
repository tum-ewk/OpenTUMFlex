...
def plot_flex_prices(power, output_path, save_figure=True, figure_path='figures/'):
    ...
    #                color=plot_color, linestyle='dashed')
    # axs[1, 0].plot(tick_range,
    #                weekday_opt_per_daytime['P_ev_opt_sum_con']/ weekday_opt_per_daytime['n_veh_avail'],
    ...
    #                color=plot_color, linestyle='dashed')
    # axs[1, 1].plot(tick_range,
    #                weekday_opt_per_daytime['P_ev_opt_sum_tou']/ weekday_opt_per_daytime['n_veh_avail'],
    #                color='r', alpha=0.5, zorder=10, linestyle='solid')
    # axs[1, 1].grid()
    ...
    #                color=plot_color, linestyle='dashed')
    # axs[1, 3].plot(tick_range,
    #                weekday_opt_per_daytime['P_ev_opt_sum_tou_mi']/ weekday_opt_per_daytime['n_veh_avail'],
    #                color='r', alpha=0.5, zorder=10, linestyle='solid')
    # axs[1, 3].grid()
    #
    # # Con + MI on weekdays
    ...
    #                color=plot_color, linestyle='dashed')
    # axs[1, 2].plot(tick_range,
    #                weekday_opt_per_daytime['P_ev_opt_sum_con_mi']/ weekday_opt_per_daytime['n_veh_avail'],
    #                color='r', alpha=0.5, zorder=10, linestyle='solid')
    # axs[1, 2].grid()
    #
    # # RTP on weekdays
    ...
    #                color=plot_color, linestyle='dashed')
    # axs[1, 4].plot(tick_range,
    #                weekday_opt_per_daytime['P_ev_opt_sum_rtp']/ weekday_opt_per_daytime['n_veh_avail'],
    #                color='r', alpha=0.5, zorder=10, linestyle='solid')
    # axs[1, 4].grid()
