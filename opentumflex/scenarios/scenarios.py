...
def scenario_combination_test(my_ems, test_code):
    ...
    if s_bat:my_ems['devices'].update(create_device(device_name='bat', minpow=0.5, maxpow=3, stocap=5, init_soc=45, eta=0.95)) 
    ...
    if not s_bat:my_ems['devices'].update(create_device(device_name='bat', minpow=0, maxpow=0, stocap=0, init_soc=0, eta=0.95)) 
